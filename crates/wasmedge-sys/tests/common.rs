...
pub fn create_extern_module(name: impl AsRef<str>) -> ImportModule<NeverType> {
    ...
    let result = Function::create(&func_ty, extern_add, 0);
    assert!(result.is_ok());
    ...
    let result = FuncType::create(vec![ValType::ExternRef, ValType::I32], vec![ValType::I32]);
    let func_ty = result.unwrap();
    let result = Function::create(&func_ty, extern_sub, 0);
    assert!(result.is_ok());
    let host_func = result.unwrap();
    ...
    let result = FuncType::create(vec![ValType::ExternRef, ValType::I32], vec![ValType::I32]);
    let func_ty = result.unwrap();
    let result = Function::create(&func_ty, extern_mul, 0);
    assert!(result.is_ok());
    let host_func = result.unwrap();
    ...
    let result = FuncType::create(vec![ValType::ExternRef, ValType::I32], vec![ValType::I32]);
    let func_ty = result.unwrap();
    let result = Function::create(&func_ty, extern_div, 0);
    assert!(result.is_ok());
    let host_func = result.unwrap();
    ...
    assert!(result.is_ok());
    let func_ty = result.unwrap();
    let result = Function::create(&func_ty, extern_term, 0);
    let host_func = result.unwrap();
    ...
    assert!(result.is_ok());
    let func_ty = result.unwrap();
    let result = Function::create(&func_ty, extern_fail, 0);
    let host_func = result.unwrap();
